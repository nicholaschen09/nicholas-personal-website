...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'blog.grpc.whatIsText': "gRPC (gRPC Remote Procedure Call) is an open-source remote procedure call framework initially developed by Google. It allows a client application to directly call a method on a server application on a different machine as if it were a local object, making it easier to create distributed applications and services. Unlike REST, which is resource-oriented, gRPC is action-oriented.",
