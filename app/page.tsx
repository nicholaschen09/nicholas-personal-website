    ...
    <main className="flex min-h-screen flex-col items-center p-6 md:p-24">
      ...
      <div className="max-w-6xl w-full space-y-4 md:space-y-6 mb-10 md:mb-16 pt-24 md:pt-16">
        ...
        <div className="h-auto min-h-[150px] md:min-h-[120px]">
          <TypeAnimation
            sequence={[
              "I am a software engineer intern at Ownr doing full stack web development, infrastructure and cloud computing. I am studying Systems Design Engineering at the University of Waterloo. Previously, I've helped create awesome things at RBC and Meta Hash Capital.",
              1000,
            ]}
            wrapper="p"
            speed={50}
